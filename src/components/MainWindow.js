  ...
  return (
    <Container className="border bccard col-9 pt-5 pb-5 px-4">
      {music.map((song) => (
          ...
          <div className="card2 bgimg mt-4 col-3 p-2 shadow-md rounded text-center"          
            key={song.id}>
               <img className="bird" src="https://cdn-icons-png.flaticon.com/512/3362/3362384.png" width= "50px" height="50px"/>
            {song.songPath
              .trim()
              .split("\\")
              .slice(-1)
